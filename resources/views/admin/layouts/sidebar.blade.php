<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="{{ route('admin.dashboard') }}" class="navbar-brand mx-4 center mb-4">
            <img class="center" src="{{ asset('admin/img/logo admin.png') }}" alt="Admin Icon"
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                <img class="rounded-circle" src="{{ asset('admin/img/admin-default-avatar.png') }}" alt="Admin Icon"
