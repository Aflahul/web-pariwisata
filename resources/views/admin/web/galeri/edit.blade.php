...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light rounded p-4">
        ...
        <form action="{{ route('admin.web.galeri.update', $galeri->id) }}" 
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="tipe_media" class="form-select" id="tipe_media">
                            ...
                            <option value="video" {{ $galeri->tipe_media === 'video' ? 'selected' : '' }}>Video</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" rows="4" class="form-control">
                            {{ old('deskripsi', $galeri->deskripsi) }}
                        </textarea>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    {{-- MODE FOTO --}}
                    <div class="mb-3 {{ $galeri->tipe_media === 'image' ? '' : 'd-none' }}" id="wrap_foto">
                        ...
                        @if ($galeri->file_path)
                            ...
                            {{-- HAPUS FOTO --}}
                            <form action="{{ route('admin.web.galeri.hapus-file', $galeri->id) }}"
                                  method="POST" 
                    ...
                    {{-- MODE VIDEO --}}
                    <div class="mb-3 {{ $galeri->tipe_media === 'video' ? '' : 'd-none' }}" id="wrap_video">
